...
import { EvaluatorAdapterBinding, JudgeConectorAdapterBindings as JudgeConnectorAdapterBindings, QueueListenerAdapterBindinds, RabbitServiceBindings } from './keys';
